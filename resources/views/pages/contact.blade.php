  ...
  <div class="container contact_block">
    <div class="contact-form">
      <div class="col-sm-6">                
        ...
        @endif      
        <form action="/contact_send" id="contact_form" name="contact_form" class="default-form2" method="POST">
          @csrf
          <ul class="row">
            <li class="col-sm-6">
            ...
            <li class="col-sm-8">
              <button type="submit" value="submit" class="btn font-montserrat" id="btn_submit">Send Message</button>
            </li>
          </ul>
        </form>
      </div>
